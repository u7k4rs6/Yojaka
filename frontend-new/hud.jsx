...
const { useEffect, useState, useRef, useMemo, useCallback, createContext, useContext } = React;
...
Object.assign(window, { RegMarks, Panel, Glitch, Sig, Tag, Label, Btn, CRTSwitch, LiveClock, Globe, StatusTicker });
